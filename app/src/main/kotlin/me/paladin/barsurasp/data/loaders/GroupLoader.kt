...
object GroupLoader {
    ...
    suspend fun getTimetable(
        group: String,
        week: String
    ): Timetable.Group? = withContext(Dispatchers.Default) {
        ...
        return@withContext Timetable.Group(
    ...
    suspend fun getFaculties(): List<Faculty> = withContext(Dispatchers.Default) {
